...
<body>
	...
	<form action="cost/update.do" method="post" class="form-horizontal"
		...
		<input type="hidden" name="mhcx" value="${mhcx }"> <input
			type="hidden" name="Cost_id" value="${Cost_Info.cost_id }">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="Cost_name"
							placeholder="请输入费用名称" value="${Cost_Info.cost_name }"
							 data-rule="required;Cost_name;"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea rows="" cols="" class="form-control"
							...
							data-rule-Cost_desc="[/^[\u4e00-\u9fa5]{2,30}$/, '输入有误,请重新输入']"
							data-tip="请描述角色" 
							data-msg-required="请输入费用描述"
							>${Cost_Info.cost_desc }</textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-7" align="center">
				<input type="submit" value="修改费用" class="btn btn-success" /> <a
