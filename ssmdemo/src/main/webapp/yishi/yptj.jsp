...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px">请根据情况推荐药品</h5>
		<div class="row">
			<div class="col-sm-7 form-item">
				<div class="form-group">
					<label class="col-sm-3 control-label">留言编号:</label>
					<div class="col-sm-9">
					<span style="color:#F00">${dc.id}</span>
			...
			<div class="col-sm-7 form-item">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<span style="color:#F00">${dc.panel_name}</span>
			...
			<div class="col-sm-7 form-item">
				<div class="form-group">
					<label class="col-sm-3 control-label">具体留言:</label>
					<div class="col-sm-9">
						
						<span style="color:#F00">${dc.liuyan}</span>
					</div>
				</div>
			</div>
			<div class="row" style="padding: 15px;">
			<table class="table" style="margin-left:80px;">
				...
				<c:forEach var="y" items="${ywlist}">
					<tr>
						<td>${y.id }</td>
						<td>${y.t1 }</td>
						<td>${y.name }</td>
						<td><button onclick="alert('感谢您的推荐!')" 
				class="btn btn-success"><a  href="ckly.do">推荐<a></button></td>
