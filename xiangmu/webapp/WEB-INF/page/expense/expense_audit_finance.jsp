...
<body>
	...
	<form action="expense/finance.do" method="post" id="f1" class="form-inline">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			<div class="form-group">
				<label>报销人</label> <input type="text" class="form-control"
					 placeholder="请输入报销人" name="User_name" value="${User_name }" />
					<label>报销时间</label> <input type="text" class="form-control"
					 placeholder="请输入报销时间" onclick="WdatePicker()" name="Expense_time" value="${Expense_time }"/>	
			</div>
			...
			<table class="table ">
				...
				<c:forEach var="s" items="${finlist }">
					<tr>
						...
						<td><a href="expense/finsh.do?expense_id=${s.expense_id }&User_name=${User_name}&Expense_time=${Expense_time}">审核</a></td>
					</tr>
				</c:forEach>			
			</table>
		...
		<div align="right" style="padding: 10px;">
			<pg:pager items="${total }" url="expense/finance.do" maxIndexPages="3"
