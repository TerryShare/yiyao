...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="row" style="padding: 15px;">
			<form action="tzyw.do" method="post" class="form-horizontal"
		data-validator-option="{timely:2, theme:'yellow_right_effect'}">
		

		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px">请输入购买信息</h5>
		<div class="row">
			<div class="col-sm-7 form-item">
				<div class="form-group">
					<label class="col-sm-3 control-label">医药编号:</label>
					<div class="col-sm-9">
					<span style="color:#F00">${gm.id}</span>
			...
			<div class="col-sm-7 form-item">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<span style="color:#F00">${gm.t1}</span>
			...
			<div class="col-sm-7 form-item">
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span style="color:#F00">${gm.name}</span>
					</div>
				</div>
			</div>
			<div class="col-sm-7 form-item">
			...
			<div class="col-sm-7 form-item">
				<div class="form-group">
					...
					<div class="col-sm-9">
					<span style="color:#F00">货到付款(默认)</span>
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<button onclick="alert('订单已提交,请注意及时收货!')" 
				class="btn btn-success"><a  href="tzyw.do">提交订单<a></button>
			</div>
		</div>
	</form>
