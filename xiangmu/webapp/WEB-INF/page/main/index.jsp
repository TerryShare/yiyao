...
<body>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="javascript:void(0)" class="navbar-brand"> <small>
						<i class="icon-leaf"></i> 智达教育企业费用管理系统
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header"><i class="icon-envelope-alt"></i>
								<a href="user/sjx.do" target="mainframe">查看邮箱</a></li>
						</ul></li>
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="user/chakan.do?User_id=${User_Info.user_id }" target="mainframe"> <i class="icon-user"></i>
									个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="user/tuichu.do"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="salary/baobiao.do" target="mainframe">
		...
		<c:forEach var="s" items="${qxlist }">
						
				<c:if test="${s.prent_menu_id==0 }">
					<li><a href="javascript:void(0)" target="mainframe"
								class="dropdown-toggle"> <i class="icon-desktop"></i> <span
								class="menu-text"> ${s.menu_name }</span> <b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
							<c:forEach var="a" items="${qxlist1 }">
									<c:if test="${a.prent_menu_id==s.menu_id }">
										
													<li>
														<a href="${a.menu_url }" target="mainframe"> <i
															class="icon-double-angle-right"></i> ${a.menu_name }
														</a>
													</li>
									</c:if>
						</c:forEach>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="user/bootm.do"
