...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-header">
					<h1>
						医药选购 <small> <i class="icon-double-angle-right"></i>
						</small>
					</h1>
				</div>
				<!-- /.page-header -->
		...
		<div class="row" style="padding: 15px;">
			<form action="lytj.do" method="post" class="form-horizontal"
		data-validator-option="{timely:2, theme:'yellow_right_effect'}">
		

		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px">请输入要咨询的问题</h5>
			
			<input type="hidden" value="${sf}" name="panel_name" id="panel_name">
			<input type="hidden" value="3" name="id" id="panel_name">
			
			
		<div class="row">
			<div class="col-sm-7 form-item">
				<div class="form-group">
					<label class="col-sm-3 control-label">医师编号:</label>
					<div class="col-sm-9">
					<span style="color:#F00"  >${ysly.id}</span>
						<input type="hidden" value="${ysly.id}" name="panel_id" >
					</div>
				</div>
			</div>
			<div class="col-sm-7 form-item">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<span style="color:#F00">${ysly.name}</span>
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<button onclick="alert('问题已提交!')" 
				class="btn btn-success">提交问题</button>
			</div>
		</div>
	</form>
